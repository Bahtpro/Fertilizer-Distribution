...
public class DBHelper {
    ...
    public long insertEntry(String Name, char Age, Long MobileNo, String TicketType, String ServiceType, String Depart, String Arrive, String Date, String Time) {

        ContentValues contentValues=new ContentValues();
        contentValues.put(COL_NAME,Name);
        contentValues.put(COL_NAME1, String.valueOf(Age));
